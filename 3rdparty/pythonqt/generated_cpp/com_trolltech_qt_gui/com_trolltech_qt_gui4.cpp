...
if (_wrapper) {
  ...
  if (obj && !PythonQtSlotFunction_Check(obj)) {
    ...
    static const PythonQtMethodInfo* methodInfo = PythonQtMethodInfo::getCachedMethodInfoFromArgumentList(3, argumentList);
      QImageIOPlugin::Capabilities returnValue = 0;
