...
Notarizing (submitting the signed app and dmg to Apple's notary service and
stapling the ticket) is narrower: only pushes to `master`, the builds whose
DMGs people download. It waits on Apple, which usually answers within ten
